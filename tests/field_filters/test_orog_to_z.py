...
def orog_source(test_source):
    OROG_SPEC = [
        {"parameter.variable": "orog", "parameter.units": "m", "data.values": OROG_VALUES, **MOCK_FIELD_METADATA}
    ]
...
def z_source(test_source):
    Z_SPEC = [
        {"parameter.variable": "z", "parameter.units": "m**2 s**-2", "data.values": Z_VALUES, **MOCK_FIELD_METADATA}
    ]
