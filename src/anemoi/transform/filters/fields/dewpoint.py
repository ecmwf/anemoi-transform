...
class DewPoint(MatchingFieldsFilter):
    ...
    def forward_transform(self, relative_humidity: Field, temperature: Field) -> Iterator[Field]:
        ...
        yield self.new_field_from_numpy(td, template=relative_humidity, **{"parameter.variable": self.dewpoint})
    ...
    def backward_transform(self, dewpoint: Field, temperature: Field) -> Iterator[Field]:
        ...
        yield self.new_field_from_numpy(rh, template=temperature, **{"parameter.variable": self.relative_humidity})
