    ...
    DDFF_SPEC = [
        {
            ...
            "parameter.units": "m s**-1",
            "vertical.level": 500,
            "data.values": DD_VALUES[500],
            **MOCK_FIELD_METADATA,
        },
        {
            "parameter.variable": "wdir",
            "parameter.units": "degree",
            "vertical.level": 500,
            "data.values": FF_VALUES[500],
            **MOCK_FIELD_METADATA,
        },
        {
            "parameter.variable": "ws",
