...
Q2M_VALUES = np.array([[0. , 0.0020382843983213, 0.0030328053695092, 0.0041460924390494], [0.0037995906399138, 0.0013875242433219, 0.007505377077515 , 0.0087464703870742], [0.0146151303517757, 0.0191325953775226, 0.0004603447218772, 0.0001570271615703]])
D2M_VALUES = np.array([[170.15730777, 262.02113729, 270.2148745 , 273.19127971], [272.73039562, 259.95112967, 283.13080014, 285.45374602], [293.33820197, 297.23259971, 247.36689612, 235.17086978]])
SP_VALUES  = np.array([[80417, 79975, 101152, 92153], [97221, 99400, 102021, 102212], [101488, 98555, 101390, 91533]]) 

T_VALUES = {
    130: np.array([[296.25, 295.96, 299.70, 295.18], [292.79, 268.63, 289.17, 289.32], [294.42, 298.49, 250.84, 248.22]]),
    131: np.array([[296.57, 296.09, 299.30, 294.59], [292.51, 268.83, 289.53, 289.67], [294.79, 298.26, 250.33, 248.18]]),
    132: np.array([[296.84, 296.08, 298.50, 294.00], [292.10, 269.00, 289.85, 289.99], [295.12, 298.22, 250.07, 248.02]]),
    133: np.array([[297.08, 296.03, 297.52, 293.43], [291.51, 269.13, 290.14, 290.29], [295.43, 298.26, 250.03, 247.61]]),
    134: np.array([[297.31, 296.07, 296.64, 292.98], [290.71, 269.20, 290.41, 290.56], [295.72, 298.34, 250.15, 246.95]]),
    135: np.array([[297.50, 296.08, 295.91, 292.61], [289.67, 269.25, 290.65, 290.80], [295.98, 298.43, 250.25, 246.02]]),
    136: np.array([[297.67, 295.83, 295.22, 292.19], [288.51, 269.26, 290.87, 291.02], [296.24, 298.50, 250.34, 244.79]]),
    137: np.array([[297.82, 294.65, 294.48, 291.79], [287.30, 269.31, 291.06, 291.21], [296.50, 298.53, 250.34, 243.16]]),
}

Q_VALUES = {
    130: np.array([[0.000873, 0.001420, 0.002587, 0.004202], [0.003415, 0.000747, 0.006379, 0.007829], [0.013675, 0.017080, 0.000523, 0.000321]]),
    131: np.array([[0.000887, 0.001491, 0.002595, 0.004178], [0.003460, 0.000775, 0.006404, 0.007860], [0.013695, 0.017544, 0.000491, 0.000315]]),
    132: np.array([[0.000902, 0.001581, 0.002652, 0.004166], [0.003513, 0.000806, 0.006435, 0.007895], [0.013715, 0.017879, 0.000480, 0.000308]]),
    133: np.array([[0.000919, 0.001712, 0.002732, 0.004163], [0.003559, 0.000844, 0.006472, 0.007936], [0.013737, 0.018107, 0.000485, 0.000301]]),
    134: np.array([[0.000934, 0.001774, 0.002803, 0.004164], [0.003592, 0.000893, 0.006520, 0.007989], [0.013764, 0.018263, 0.000480, 0.000293]]),
    135: np.array([[0.000949, 0.001818, 0.002860, 0.004169], [0.003621, 0.000946, 0.006589, 0.008061], [0.013800, 0.018377, 0.000479, 0.000283]]),
    136: np.array([[0.000967, 0.001873, 0.002905, 0.004181], [0.003655, 0.001024, 0.006701, 0.008176], [0.013856, 0.018466, 0.000482, 0.000268]]),
    137: np.array([[0.000991, 0.001986, 0.002948, 0.004209], [0.003709, 0.001124, 0.006963, 0.008426], [0.013991, 0.018540, 0.000485, 0.000245]]),
}
...
def test_specific_humidity_to_dewpoint_from_file(test_source):
    ...
    expected_dewpoint_temperature = test_source("anemoi-transform/filters/single_level_dewpoint_temperature.npy").ds.to_numpy()
...
def test_dewpoint_to_specific_humidity_from_file(test_source):
    source = test_source("anemoi-transform/filters/input_single_level_specific_humidity_to_relative_humidity.grib")
    input_dewpoint_temperature = test_source("anemoi-transform/filters/single_level_dewpoint_temperature.npy").ds.to_numpy()
    new_2d = source.ds.sel(param="2d")[0].clone(
        values = input_dewpoint_temperature,
        param="2td"
    )
    md = source.ds.sel(param="2d")[0].metadata()
    ds = source.ds.sel(param=["2sh","2t","sp","q","t"])
    ds += ekd.FieldList.from_array(
        input_dewpoint_temperature,
        md
    )
    source.ds = ds
