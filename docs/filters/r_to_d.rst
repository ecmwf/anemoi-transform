...
relative humidity and temperature. For details regarding the exact formula
used please refer to `earthkit-meteo <https://github.com/ecmwf/earthkit-meteo/blob/develop/src/earthkit/meteo/thermo/array/thermo.py>`_
